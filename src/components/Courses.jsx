...
// Free Unsplash images — one per course, no API key needed
const COURSE_IMAGES = {
...
function CourseImage({ course }) {
  ...
  const src = COURSE_IMAGES[course.title]
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        background: hovered ? course.color : 'var(--surface-gray)',
        borderTop: '1px solid var(--border-subtle)',
        fontSize: '0.83rem', fontWeight: 700,
        color: hovered ? 'white' : 'var(--brand-primary)',
        transition: 'all 0.3s ease',
      }}>
        Explore Course
